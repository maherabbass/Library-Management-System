  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-subtitle">Sign in to access the library system</p>

        <button
          className="btn btn-google"
          onClick={() => { window.location.href = api.loginUrl('google'); }}
        >
        ...
        <button
          ...
          onClick={() => { window.location.href = api.loginUrl('github'); }}
        >
        ...
        <p style={{ marginTop: '1.5rem', fontSize: '.8rem', color: 'var(--text-muted)' }}>
          New users are automatically assigned the <strong>Member</strong> role.
